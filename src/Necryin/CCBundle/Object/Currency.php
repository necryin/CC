...
class Currency
{
    ...
    public function __construct($currencyCode)
    {
        ...
        else
        {
            ...
            {
                if($currency['numeric_code'] === (int) $currencyCode)
                {
     ...
     *
     * @param string $code                  буквенный код
     * @param string $displayName           отображаемое имя
     * @param int    $numericCode           цифровой код
     * @param int    $defaultFractionDigits количество цифр дробной части
     * @param int    $subUnit               размерность под-валюты (например 1 рубль = 100 копеек)
     */
    ...
    /**
     * Возвращает код валюты при приведении класса к строке
     *
     * @return string
     */
